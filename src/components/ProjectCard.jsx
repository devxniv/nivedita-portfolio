...
const ProjectCard = ({ title, description, image, tech, tag, demo, code }) => {
  return (
    <div className="bg-dark-300 rounded-2xl overflow-hidden hover:-translate-y-2 transition duration-300 cursor-pointer flex flex-col h-full">
      ...
      <div className="p-6 flex flex-col flex-1">
        {tag && (
          <span className="inline-block w-fit px-3 py-1 bg-purple/20 text-white text-sm rounded-full mb-2">
            {tag}
          </span>
        )}
